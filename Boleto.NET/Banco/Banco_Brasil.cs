    ...
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            if (string.IsNullOrEmpty(boleto.Carteira))
                throw new NotImplementedException("Carteira no informada. Utilize a carteira 16, 17, 18 ou 18-019.");
            ...
            if (!boleto.Carteira.Equals("16") &
                ...
                throw new NotImplementedException("Carteira não implementada. Utilize a carteira 16, 17, 18 ou 18-019.");
        ...
        internal static string Mod11BancoBrasil(string value)
        {
            ...
            */
            ...
            #endregion Trecho do manual DVMD11.doc
