...
{
    public partial class r0014 : CompSoft.Reports.ReportBase_Retrato
    {
        public r0014()
        {
            InitializeComponent();

            this.DataMember = "Fluxo";
        }
        ...
        public override void Set_DataMember_DetailReports()
        {
            ...
            {
                this.Report_DataSet.Tables[this.DataMember].Clear();

                FormSet f = ((FormSet)Propriedades.FormMain.ActiveMdiChild);
                DataView dv = new DataView(f.DataSetLocal.Tables[this.DataMember], "", "Referencia", DataViewRowState.CurrentRows);
